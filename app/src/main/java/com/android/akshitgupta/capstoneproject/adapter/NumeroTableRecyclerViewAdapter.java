...
public class NumeroTableRecyclerViewAdapter extends RecyclerView.Adapter<NumeroTableRecyclerViewAdapter.MyViewHolder> {

    private List<NumeroPrediction> numeroPredictions;
    private Context context;
    private NumeroTableRecyclerViewAdapter adapter;
    private SharedPreferences prefs;

    public NumeroTableRecyclerViewAdapter(List<NumeroPrediction> numeroPredictions, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_numero_table, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            dailyTitleView = (TextView) view.findViewById(R.id.numero_table_title);
            dailyDescriptionView = (TextView) view.findViewById(R.id.numero_table_desc);
        }
    }
}